...
import { z } from "zod";
import { buildPriorityExport } from "./lib/readwise-priority-v8.js";
import type { PriorityExportItem, PriorityOverridesConfig } from "./lib/readwise-priority-v8.js";
...
async function main() {
  ...
  if (!validatePriorityJudgments(judgmentValue)) {
